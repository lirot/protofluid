var jwt = (function() {
  ...
  var newWinLink = "http://" + location.host + "/psp/" + url_xx[4] +  "/EMPLOYEE/PSFT_EP/s/WEBLIB_PTPP_SC.HOMEPAGE.FieldFormula.IScript_AppHP";
  ...
  function timedCount() {
                        ...
                        if (c < 30) {
                                  var parms = {
                                    ...
                                    popCallback : function(){ c= timeout}
                                  };
  ...
  var stopCount = function() {
   ...
   var init = function(row, worklist, that) {
       ...
       jQuery("#processing").on('hide.processing' , function(){ jQuery(this).hide() })
       jQuery("#processing").on('show.processing' , function(){ jQuery(this).show() })
